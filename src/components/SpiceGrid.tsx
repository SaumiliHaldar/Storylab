...
const spices = [
  { id: 1, title: 'Cardamom', origin: 'Kerala, India', desc: 'The queen of spices. Floral, warm, and unmistakably chai.', image: '/images/Cardamom.png' },
  { id: 2, title: 'Ginger', origin: 'South Asia', desc: 'Raw heat that cuts through the milk and wakes every sense.', image: '/images/Ginger.png' },
  { id: 3, title: 'Cinnamon', origin: 'Sri Lanka', desc: 'Bark coiled in sweetness. A whisper of the tropics.', image: '/images/Cinnamon.png' },
  { id: 4, title: 'Clove', origin: 'Maluku Islands', desc: 'Intense and medicinal. The anchor of the spice chorus.', image: '/images/Clove.png' },
  { id: 5, title: 'Black Pepper', origin: 'Western Ghats', desc: 'The quiet fire. Subtle until you notice it everywhere.', image: '/images/BlackPepper.png' },
  { id: 6, title: 'Tulsi', origin: 'Indian Subcontinent', desc: 'Sacred basil. The soul of the masala, the one that heals.', image: '/images/Tulsi.png' },
];
          ...
          {spices.map((spice, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
                {/* Top slide-in ember bar */}
                <div className="absolute top-0 left-0 w-full h-[2px] bg-ember transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-500 ease-out z-10"></div>
              ...
              <div className="relative z-30">
                <p className="font-body text-bark text-xs tracking-[0.2em] uppercase mb-2 transform -translate-y-0 group-hover:-translate-y-1 transition-transform duration-400">
                  {spice.origin}
                </p>
                <h3 className="font-serif text-2xl md:text-3xl text-cream mb-3 group-hover:text-ember group-hover:italic transition-all duration-300">
                  {spice.title}
                </h3>
